...
/**
 * TODO Абстрактний клас без можливості створення екземплярів
 * TODO Характеристики: назва, кількість коліс
 * TODO Методи: конструктор, геттери і сеттери для характеристик, додатковий метод "Рух" та "Управління"
 */
